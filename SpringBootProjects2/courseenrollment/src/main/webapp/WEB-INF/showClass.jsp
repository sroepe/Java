...
<html>
	...
	<body>
		...
		<form:form method="POST" action="/addUserToCourse/${id}" modelAttribute="user" >		
			<p><form:label path="username">Add User:
			<form:errors path="username"/>
			<form:select path="username" items="${notCourseUsers}" itemValue="id" itemLabel="username"/></form:label>
			</p>
